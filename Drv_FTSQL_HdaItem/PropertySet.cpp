...
DrvFTSQLHdaItem::PropertySet::PropertySet() :propertyList()
{

}

DrvFTSQLHdaItem::PropertySet::~PropertySet()
{
	propertyList.clear();
}


void DrvFTSQLHdaItem::PropertySet::GetPropertyInfoList(ODS::PropertyInfo** ppPropInfoList, ULONG* pulCount) const
{
...
void DrvFTSQLHdaItem::PropertySet::DestroyPropertyInfoList(ODS::PropertyInfo* pPropInfoList, ULONG ulCount) const
{
	delete[] pPropInfoList;
}

void DrvFTSQLHdaItem::PropertySet::GetPropertyList(ODS::Property** ppPropList, ULONG* pulCount) const
{
	*ppPropList = 0;
	if (propertyList.empty()) {
		*pulCount = 0;
...
void DrvFTSQLHdaItem::PropertySet::DestroyPropertyList(ODS::Property* pPropList, ULONG ulCount) const
{
	delete[] pPropList;
}

INT DrvFTSQLHdaItem::PropertySet::GetProperty(ULONG ulPropId, ODS::Property* pProperty) const
{
...
INT DrvFTSQLHdaItem::PropertySet::GetProperty(const TCHAR* pPropName, ODS::Property* pProperty) const
{
	if (!pPropName)
...
INT DrvFTSQLHdaItem::PropertySet::SetProperty(const ODS::Property* pProperty)
{
...
INT DrvFTSQLHdaItem::PropertySet::AddProperty(const ULONG ulId, const TCHAR* szName, const TCHAR* szValue)
{
	ODS::Property prop;
...
INT DrvFTSQLHdaItem::PropertySet::AddProperty(const ULONG ulId, const TCHAR* szName, const VARIANT* pValue)
{
	ODS::Property prop;
